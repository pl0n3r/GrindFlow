...
- El token de completion se cifra con AES-256-GCM cuando existe un secreto de al menos 32 bytes y queda ligado a organización, actor, disk, key, nombre, MIME declarado, tamaño y expiración de 5 a 60 minutos. Sin secreto suficiente u OpenSSL, el servicio queda no configurado en vez de impedir arrancar el contenedor.
