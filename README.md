...
| CI del PR | ✅ ~~VALIDATED IN CODE v0.1.79~~ | run `35677876123` success sobre `1d2d1b326939186fae0b1e1e515ff3b737efed34`; head actual pendiente de CI |
| Sonar | ✅ ~~Quality Gate v0.1.79 success~~ | check success sobre `1d2d1b326939186fae0b1e1e515ff3b737efed34`; head actual pendiente de Sonar |
...
- Contrato sintético: login/dashboard HTTP 401/403/419/422/429, redirects 301/302/303/307/308, rutas censuradas, diagnóstico remoto reducido a conteo/HTTP/método permitido y aserciones negativas fail-closed. No se imprimen cuerpos, valores de headers HTTP ni trazas/mensajes remotos.
...
## Validación
- CI `35677876123` y Sonar success sobre `1d2d1b326939186fae0b1e1e515ff3b737efed34`; verificar CI/Sonar y CodeRabbit del nuevo SHA tras cubrir todos los HTTP 3xx. `fast[contracts]` usa mocks, nunca la contraseña E2E real.
