...
- El comando Artisan emite código fijo de precondición, lock, conflicto de membresía, backup o errores SQL/PDO de transacción; los desconocidos mantienen `provision-failed`.
...
## Validación
- PHPUnit cubre PDO antes del callback, comandos fallidos, membresías, código efímero y allowlist HTTP; contrato shell verifica códigos seguros.
