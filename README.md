...
| CI del PR | ✅ ~~VALIDATED IN CODE v0.1.79~~ | run `35677070462` success sobre `4848b80e49bd8b8a5adb08288d47823ada8e87af`; último fix pendiente de CI |
| Sonar | ✅ ~~Quality Gate v0.1.79 success~~ | check success sobre `4848b80e49bd8b8a5adb08288d47823ada8e87af`; último fix pendiente de Sonar |
...
- Contrato sintético: login/dashboard HTTP 401/403/419/422/429, redirects 302/303, rutas censuradas, diagnóstico remoto reducido a conteo/HTTP/método permitido y aserciones negativas fail-closed. No se imprimen cuerpos, valores de headers HTTP ni trazas/mensajes remotos.
...
## Validación
- CI `35677070462` y Sonar success sobre `4848b80e49bd8b8a5adb08288d47823ada8e87af`; verificar nuevamente CI/Sonar y CodeRabbit sobre el nuevo SHA tras eliminar valores de headers. `fast[contracts]` usa mocks, nunca la contraseña E2E real.
