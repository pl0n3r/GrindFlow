...
assert_rejected   "DATABASE_URL could not be parsed."   env GF_RESTORE_DRILL_APPROVED=1 APP_ENV=test CI=true     DATABASE_URL='pgsql://grindflow@127.0.0.1:3306/grindflow_symfony_ci'     bash "$SCRIPT"
